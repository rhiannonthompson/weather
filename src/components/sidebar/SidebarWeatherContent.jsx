...
export default function SidebarWeatherContent() {
  return (
    <div className="flex flex-col items-center mt-18 md:mt-28 lg:mt-20">
      ...
      <img className="w-36 md:w-52 lg:w-44" alt="current-weather" src={currentWeather} />
      ...
      <div className="mt-10 md:mt-18">
        <p className="text-3xl font-semibold text-gray-400">Showers</p>
      </div>
      <div className="mt-10 md:mt-18">
        <div className="text-xl font-semibold text-gray-400 mb-6">
          <div className="relative w-56">
            <span className="absolute left-10">Today</span>
            <span className="absolute left-1/2 w-10 text-center transform -translate-x-1/2">
              •
            </span>
      ...
      <div className="mt-4">
        <p className="text-xl font-semibold text-gray-400">Dublin</p>
      </div>
    </div>
  );
}
